...
| 区域         | 职责                                                                                                                             |
| ------------ | -------------------------------------------------------------------------------------------------------------------------------- |
| Skill        | 收集意图，按 [references/storyboard-methodology.md](references/storyboard-methodology.md) 规划分镜，编写创意文档，并构建公共请求 |
...
创意 brief 的收集与分镜生成不属于 core。Skill 拥有创意层：[references/storyboard-methodology.md](references/storyboard-methodology.md) 定义了通用的分镜、音频、字幕与提示词方法；一个视频 brief 会落地为具体的 `<name>.storyboard.md` 文档，其提示词随后通过 core 提交。Provider 专属的模型、端点、凭证与响应兼容性不属于编排层。
