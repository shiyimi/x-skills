...
const events = [
  {
    name: 'change',
    label: '用户选择变化',
    description: '用户选择变化事件',
    params: [{ name: 'value', remark: '用户选择值', valueType: 'string' }],
  },
  {
    name: 'focus',
    label: '用户选择聚焦',
    description: '用户选择聚焦事件',
    params: [{ name: 'value', remark: '用户选择值', valueType: 'string' }],
  },
  {
    name: 'blur',
    label: '用户选择失去焦点',
    description: '用户选择失去焦点事件',
    params: [{ name: 'value', remark: '用户选择值', valueType: 'string' }],
  },
];
...
const userSelectConfig: WidgetConfig = {
  type: 'KUserSelector',
  label: '用户选择器',
